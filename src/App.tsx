...
const App: React.FC = () => {
  const styles: { [key: string]: CSSProperties } = {
    container: {
      ...
      backgroundImage: `linear-gradient(to top, rgba(155, 41, 172, 0.02), transparent 50%), linear-gradient(rgba(10, 5, 15, 0.8), rgba(0, 0, 0, 0.95)), url('https://i.postimg.cc/s2CZZSnL/grok-image-x1fz302.jpg')`,
